...
<form id="joinus" name="joinus" enctype="multipart/form-data">
  <div class="col-sm-12 hidden-xs" id="mask_j_us" style="height: 375px; width: 100%; background: #fff none repeat scroll 0% 0%; padding: 40px 0 0 50px !important; margin: 0px ! important;">
                    ...
                    <div class="col-sm-12 hidden-lg" id="mask_j_us" style="height: 375px; width: 100%; background: #fff none repeat scroll 0% 0%; padding: 40px 0 0 10px !important; margin: 0px ! important;">
                        <div class="msg_ack" class="col-sm-12"></div>
                        <div class="col-sm-6">
                            <span class="input input--madoka" style="margin-left: 70px; max-width: 600px;">
                          <input class="input__field input__field--madoka" type="text" id="atm_j_name" name="atm_j_name" />
                        ...
                        <div class="col-sm-6 join_leftpart">
                            ...
                            <div class="captcha">
                                <div >
                                           <img src="captcha/captcha_code_file.php?rand=<?php echo rand(); ?>" id='captchaimg' >
                                           <span style="float:left;"><img style="width:20px;float:left;font-size:10px; margin: 0px 0px 0px 5px;" src="images/refresh.png" id="refreshcaptcha"   alt="refresh" /><span style="color:#c31118;position: relative; left: -20px;top: 16px;">*</span></span>
